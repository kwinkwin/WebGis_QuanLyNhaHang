      ...
      <template v-slot:body="propsLayer">
        <q-tr :props="propsLayer">
          ...
          <q-td key="type" :props="propsLayer">
            <q-badge :class="`bg-white text-${propsLayer.row.type === LAYER_TYPE[0] ? 'green' : 'red'}`">
              {{ propsLayer.row.type }}
            </q-badge>
          </q-td>
          ...
          <q-td key="action" :props="propsLayer">
            <q-btn v-bind="actionButtonProps" 
            color= 'white'
            textColor= 'primary'
            icon="edit"
            style="margin-right: 10px">
              <!-- popup layer edit -->
              <popupLayer :key="layerPagination.page" :row="propsLayer.row" :layer-rows="propsLocation?.mapLayers" />
            </q-btn>
            <q-btn v-bind="{
              ...actionButtonProps,
              color: 'white',
